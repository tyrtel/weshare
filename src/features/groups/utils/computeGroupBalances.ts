import { calculateSettlements, computeMemberNetBalances, type MemberBalance } from '../../../core/logic/settlement';
...
export function computeGroupBalances(
  ...
  return {
    settlements:    calculateSettlements(members, allExpenses),
    memberBalances: computeMemberNetBalances(members, allExpenses),
  };
}
